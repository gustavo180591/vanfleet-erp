<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto">
        <div class="bg-white shadow-sm rounded-lg p-6">
            <h2 class="text-lg font-semibold mb-6">Nueva Factura</h2>
                                ...
                                <select id="rental_contract_id" name="rental_contract_id" 
                                    ...
                                    @foreach($rentalContracts as $contract)
                                        <option value="{{ $contract->id }}" 
                                                {{ (old('rental_contract_id', $contractId) == $contract->id) ? 'selected' : '' }}
                        ...
                        <div id="items-container" class="space-y-4">
                            ...
                            <div class="grid grid-cols-12 gap-4 items-end" data-item>
                                ...
                                <div class="col-span-2">
                                    ...
                                    <input type="number" name="items[0][quantity]" step="0.01" min="0.01" value="1"
                                           class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm">
                                </div>
                                <div class="col-span-2">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('add-item').addEventListener('click', function() {
            ...
            const newItemHtml = newItem.outerHTML.replace(/items\[0\]/g, `items[${itemIndex}]`);
            ...
            customerSelect.addEventListener('change', function() {
                ...
                options.forEach(option => {
                    if (option.value === '') {
                        ...
                        if (option.dataset.customerId === customerId || customerId === '') {
                            option.style.display = 'block';
                        } else {
